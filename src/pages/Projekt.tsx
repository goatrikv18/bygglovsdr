          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full md:w-64 pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-brand-500"
                value={searchQuery}
                      ...
                      <div className="mt-auto">
                        <div className="flex flex-wrap gap-2 mb-4">
                          {project.services.map((service, i) => (
                            <span key={i} className="inline-block bg-brand-50 text-brand-600 text-xs font-medium px-2 py-1 rounded">
                              {service}
                            </span>
                          ))}
                        </div>
                        
                        <button className="inline-flex items-center text-brand-500 font-medium hover:text-brand-600 group">
